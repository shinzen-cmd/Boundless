...
// reportErrorToRemote path Metro bundling errors already use) and chain to RN's
// original handler for FATAL errors so the crash actually surfaces rather than
// silently freezing. Non-fatal warnings stay quiet, preserving the clean
